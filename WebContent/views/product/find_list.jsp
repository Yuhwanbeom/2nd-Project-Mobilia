...
<div id="product_list">
	<c:if test="${!empty plist}">
		<c:forEach var="p" items="${plist}">
			<ul id="list_ul">
				<li id="list">
					<div id="list_img">
						<a href="product_info.net?p_no=${p.p_no}"><img src="./upload${p.p_img1}" width="300"
							height="300" onmouseover="this.src='./upload${p.p_img2}'"
	...
	<c:if test="${empty plist}">
		<div>
			<p
				style="font-size: 24px; font-weight: 700; color: #a3a3a3; text-align: center;">
				등록된 상품이 없습니다.</p>
		</div>
	</c:if>
</div>
